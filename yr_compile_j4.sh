...
mkdir -p src/COMPILER_GENERATED_OUTPUT_FOLDER


cp ${COMPILER_GENERATED_OUTPUT_FOLDER_FULL_PATH}/*.hpp src/COMPILER_GENERATED_OUTPUT_FOLDER

cp ${COMPILER_GENERATED_OUTPUT_FOLDER_FULL_PATH}/*.cpp src/COMPILER_GENERATED_OUTPUT_FOLDER
