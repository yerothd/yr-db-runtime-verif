...
YRDBRUNTIMEVERIF_Logging_Info::YRDBRUNTIMEVERIF_Logging_Info(QString LOGGING_INFO)
{
	...
	A_PREVIOUS_STATE = string_logging_info_LIST.value(5);
	AN_ACCEPTING_STATE = string_logging_info_LIST.value(6);
	AN_ACCEPTING_STATE_is_error_state_VALUE = string_logging_info_LIST.value(7);
}
