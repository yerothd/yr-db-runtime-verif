/*
* yr_sd_runtime_verif_language_EXAMPLE_realcase.hpp
*
*/

#ifndef _YR_DB_VERIF_RUNTIME_MONITOR_yr_sd_runtime_verif_language_EXAMPLE_realcase_HPP_
#define _YR_DB_VERIF_RUNTIME_MONITOR_yr_sd_runtime_verif_language_EXAMPLE_realcase_HPP_
...
class yr_sd_runtime_verif_language_EXAMPLE_realcase : public YR_DB_RUNTIME_VERIF_Monitor
{
    Q_OBJECT
...
public:
    ...
    yr_sd_runtime_verif_language_EXAMPLE_realcase(YR_DB_RUNTIME_VERIF_Logger *logger);

    inline virtual ~yr_sd_runtime_verif_language_EXAMPLE_realcase()
    {
    }
...
#endif /* _YR_DB_VERIF_RUNTIME_MONITOR_yr_sd_runtime_verif_language_EXAMPLE_realcase_HPP_ */
